package com.pegasusgames.pomodorotimer;
...
public class MainActivity extends Activity {
    ...
    private static final int WEBVIEW_BG_COLOR = 0xFF1a0808;
    ...
    private static final Set<String> VALID_PRODUCTS =
        new HashSet<>(Arrays.asList("remove_ads", "coins_small", "coins_large"));

package com.pegasusgames.neverhaveiever;
...
public class MainActivity extends Activity {
    ...
    private static final int WEBVIEW_BG_COLOR = 0xFF1a1000;
    ...
    private static final Set<String> VALID_PRODUCTS =
        ...
        "coins_large", "coins_small", "remove_ads", "starter_pack"
    ...
    private static final Set<String> CONSUMABLE_PRODUCTS = new HashSet<>(Arrays.asList(
        "coins_large", "coins_small", "starter_pack"
    ));

...
|--------------|------------------|
| App ID       | `ca-app-pub-5695494884863768~9006185100` |
| Banner       | `ca-app-pub-5695494884863768/8535411813` |
| Interstitial | `ca-app-pub-5695494884863768/8333515691` |
| Rewarded     | `ca-app-pub-5695494884863768/6020929115` |
...
|--------------|---------------------------|--------------------------------------------|
| Banner       | `Puzzle2048-banner-mediation`       | Meta, Unity, Mintegral, Pangle, InMobi |
| Interstitial | `Puzzle2048-interstitial-mediation` | Meta, Unity, Mintegral, Pangle, InMobi |
| Rewarded     | `Puzzle2048-rewarded-mediation`     | Meta, Unity, Mintegral, Pangle, InMobi |

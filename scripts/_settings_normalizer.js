  ...
  function norm(){
    ...
    try{
      ...
      if(reset){frag.appendChild(hdr('Danger Zone'));
        ...
        var b=reset.querySelector('button'); if(b)b.style.cssText='padding:7px 16px;font-size:.78rem;background:transparent;color:#b0413a;border:1px solid rgba(176,65,58,.45);border-radius:8px;cursor:pointer;opacity:.85;font-weight:600;';

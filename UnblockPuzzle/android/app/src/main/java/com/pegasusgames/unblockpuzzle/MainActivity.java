...
public class MainActivity extends Activity {
    ...
    private static final int WEBVIEW_BG_COLOR = 0xFFe3efe5;
    ...
    private class NativeBridge {
        ...
        // Restricted to CROSS_PROMO_PACKAGES to prevent JS probing arbitrary
        // installed apps. Round-15.4 fix: was missing entirely so the cross-
        // promo cards always showed "Download & Get 200" even when the sister
        // app was installed.
        @JavascriptInterface

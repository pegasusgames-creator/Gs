...
|--------------|------------------|
| App ID       | `ca-app-pub-5695494884863768~2593079751` |
| Banner       | `ca-app-pub-5695494884863768/9906792093` |
| Interstitial | `ca-app-pub-5695494884863768/8593710424` |
| Rewarded     | `ca-app-pub-5695494884863768/5121369274` |
...
|--------------|---------------------------|--------------------------------------------|
| Banner       | `UnblockPuzzle-banner-mediation`       | Meta, Unity, Mintegral, Pangle, InMobi |
| Interstitial | `UnblockPuzzle-interstitial-mediation` | Meta, Unity, Mintegral, Pangle, InMobi |
| Rewarded     | `UnblockPuzzle-rewarded-mediation`     | Meta, Unity, Mintegral, Pangle, InMobi |

# MentalMathQuiz Identity

- **Category**: trivia
- **Layout archetype**: D (vertical card feed)
- **Mascot pattern**: M1 (anthropomorphized game elements (eyes, smiles, reactions))
- **Voice**: V3 (playful narrator)
- **Texture**: T3 (subtle paper texture)
- **Mood string**: trivia-knowledge

The app should feel like: curious and conversational; rewards thoughtful answers.

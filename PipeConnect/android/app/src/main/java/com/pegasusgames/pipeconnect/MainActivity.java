...
public class MainActivity extends Activity {
    ...
    private static final String ADMOB_BANNER_UNIT_ID       = "ca-app-pub-5695494884863768/5765562640";
    private static final String ADMOB_INTERSTITIAL_UNIT_ID = "ca-app-pub-5695494884863768/6329006131";
    private static final String ADMOB_REWARDED_UNIT_ID     = "ca-app-pub-5695494884863768/7889499819";
    ...
    // before the reward is granted. Per-app and unique (never shared).
    private static final String LICENSE_PUBLIC_KEY = "";
    ...
    // PART 4 — localized IAP pricing: query ProductDetails for every shop SKU
    // and push BillingClient's locale-formatted prices to the WebView, which
    // renders them in place of the hardcoded $-strings (hardcoded is fallback).
    ...
    private void pushPricesToWeb() {
        ...
        org.json.JSONObject o = new org.json.JSONObject(_localizedPrices);

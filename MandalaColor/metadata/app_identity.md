# MandalaColor Identity

- **Category**: creative
- **Layout archetype**: H (workshop / inventory)
- **Mascot pattern**: M4 (spirit-of-the-app abstract motif (particles, flow))
- **Voice**: V5 (calm / zen)
- **Texture**: T5 (hand-drawn / sketch)
- **Mood string**: creative-studio

The app should feel like: art studio; tools are visible, output is the reward.

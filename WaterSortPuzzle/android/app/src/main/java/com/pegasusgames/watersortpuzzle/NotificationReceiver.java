...
public class NotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context ctx, Intent intent) {
        if (Intent.ACTION_BOOT_COMPLETED.equals(intent.getAction())) {
            // Reschedule happens lazily on next app open; nothing to do here.
            return;
        }
        ...
        // §11.3: notifications after 21:00 (or before 09:00) must be silent.
        int hour = Calendar.getInstance().get(Calendar.HOUR_OF_DAY);
        String channelId = (hour >= 21 || hour < 9)
            ? CHANNEL_ID_SILENT : CHANNEL_ID_LOUD;

        // Re-launch the app on tap.
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(ctx, channelId)
            .setSmallIcon(R.mipmap.ic_launcher) // TODO: swap to R.drawable.ic_notification once a monochrome silhouette is added

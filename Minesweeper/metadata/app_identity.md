# Minesweeper Identity

- **Category**: arcade
- **Layout archetype**: F (direct-to-game minimal)
- **Mascot pattern**: M1 (anthropomorphized game elements (eyes, smiles, reactions))
- **Voice**: V6 (enthusiastic arcade)
- **Texture**: T6 (neon / arcade)
- **Mood string**: arcade-vivid

The app should feel like: punchy, fast, celebratory; juice on every action.

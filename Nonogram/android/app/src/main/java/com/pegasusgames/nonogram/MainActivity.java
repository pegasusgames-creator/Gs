...
public class MainActivity extends Activity {
    ...
    private static final int WEBVIEW_BG_COLOR = 0xFFf5f0e6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // (user reported: dragging on the ad scrolled the menu).
        ...
        // Ensure the banner is in front of the WebView in the z-order so
        // touches on the ad area always reach the AdView, never bleed
        // through to the WebView's scroll handler.

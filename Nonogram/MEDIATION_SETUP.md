...
|--------------|------------------|
| App ID       | `ca-app-pub-5695494884863768~8142660616` |
| Banner       | `ca-app-pub-5695494884863768/5453977585` |
| Interstitial | `ca-app-pub-5695494884863768/5823619037` |
| Rewarded     | `ca-app-pub-5695494884863768/9212199707` |
...
|--------------|---------------------------|--------------------------------------------|
| Banner       | `Nonogram-banner-mediation`       | Meta, Unity, Mintegral, Pangle, InMobi |
| Interstitial | `Nonogram-interstitial-mediation` | Meta, Unity, Mintegral, Pangle, InMobi |
| Rewarded     | `Nonogram-rewarded-mediation`     | Meta, Unity, Mintegral, Pangle, InMobi |

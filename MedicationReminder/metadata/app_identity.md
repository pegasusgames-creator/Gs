# MedicationReminder Identity

- **Category**: tracker
- **Layout archetype**: D (vertical card feed)
- **Mascot pattern**: M4 (spirit-of-the-app abstract motif (particles, flow))
- **Voice**: V5 (calm / zen)
- **Texture**: T2 (soft glassmorphism)
- **Mood string**: tracker-soft

The app should feel like: calm and supportive; encourages a daily habit without nagging.
